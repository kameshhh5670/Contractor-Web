...
const UserSignup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    const response = await axios.post(`http://localhost:3000/seller/register-seller`, newUser)
    ...
    <div>
      ...
      <div className='bg-cover bg-center flex items-center justify-center min-h-screen bg-gray-100' style={{ backgroundImage: `url(${BuildingImage})` }}>
        <div className='bg-white p-8 rounded-2xl shadow-md w-full max-w-sm'>
          ...
          <p className='text-center text-black-400'>Already have a account? <Link to='/sellerlogin' className='text-blue-600'>Login here</Link></p>
        </div>
        {/* <div>
